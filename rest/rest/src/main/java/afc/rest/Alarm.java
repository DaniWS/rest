...
//    This method doesn't parse the registration JSON. It checks which kind of sensor is it (multi-param or single-param), and delegates
//    the process of parsing and building the missing objects JSON to the corresponding class method.
